...
#define BSP_BUTTON_MAIN (GPIO_NUM_42)
#define BSP_POWER_CTL (GPIO_NUM_10)

#define BSP_I2C_SCL (GPIO_NUM_4)
...
#define BSP_I2S_DOUT (GPIO_NUM_11)
...
#define BSP_LCD_PCLK (GPIO_NUM_16)
#define BSP_LCD_MOSI (GPIO_NUM_17)
