...
#define BSP_LCD_PCLK (GPIO_NUM_47)
#define BSP_LCD_DATA0 (GPIO_NUM_21)
#define BSP_LCD_DATA1 (GPIO_NUM_48)
#define BSP_LCD_DATA2 (GPIO_NUM_40)
#define BSP_LCD_DATA3 (GPIO_NUM_39)
#define BSP_LCD_BACKLIGHT (GPIO_NUM_1)
